...
class CustomUserAdmin(UserAdmin):
    ...
    list_display: Tuple[str,...] = ('pk', 'email', 'display_name', 'year_of_birth', 'post_code') # pyre-ignore[15] - to do with the difference between the type of a tuple of strings and the type of a tuple of five strings
