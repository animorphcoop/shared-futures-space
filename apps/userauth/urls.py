...
from .views import CustomUserUpdateView, CustomUserDeleteView, profile_view, user_request_view, AdminRequestView, \
    CustomUserPersonalView, CustomLoginView, UserChatView, UserAllChatsView, user_detail, check_email, CustomPasswordResetView
...
urlpatterns: List[Union[URLResolver, URLPattern]] = [
    ...
    path('add_data/', login_required(CustomUserPersonalView.as_view(template_name='account/add_data.html')), name='account_add_data'),
