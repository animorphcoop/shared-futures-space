...
urlpatterns: List[Union[URLResolver, URLPattern]] = [
    ...
    path('ideas/view/<str:slug>/', IdeaView.as_view(template_name='idea.html'), name='view_idea'),
    path('ideas/new/', login_required(MakeIdeaView.as_view(template_name='new_idea.html')), name='new_idea'),
    path('ideas/edit/<str:slug>/', login_required(EditIdeaView.as_view(template_name='edit_idea.html')), name='edit_idea'),
