...
class River(ClusterableModel):
    ...
    def start_plan(self) -> None:
        ...
        if self.current_stage == self.Stage.ENVISION:
            ...
            send_system_message(kind='salmon_wizard', chat=self.plan_stage.general_chat, context_river=self,
            ...
            send_system_message(kind='salmon_wizard', chat=self.plan_stage.money_chat, context_river=self,
            ...
            send_system_message(kind='salmon_wizard', chat=self.plan_stage.place_chat, context_river=self,
    ...
    def start_act(self) -> None:
        ...
        if self.current_stage == self.Stage.PLAN:
            ...
            send_system_message(kind='salmon_wizard', chat=self.act_stage.money_chat, context_river=self,
                                text="Are the finances going according to plan? Are you over- or under-budget? Share and discuss money-related updates here.")
            send_system_message(kind='salmon_wizard', chat=self.act_stage.place_chat, context_river=self,
