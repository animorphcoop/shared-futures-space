...
def send_system_message(
    chat: Chat,
    kind: str,
    context_action: Optional["action.Action"] = None,
    context_river: Optional["river.River"] = None,
    context_user_a: Optional[CustomUser] = None,
    context_user_b: Optional[CustomUser] = None,
    ...
    Message.objects.create(
        ...
        text=text,
        snippet={
            "offer_of_ownership": "messaging/system_messages/offer_of_ownership.html",
