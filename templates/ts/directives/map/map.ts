...
const DEFAULT_CENTER: MapCoordinates = [54.5996, -5.9213]
    ...
    (el, {expression}, {cleanup, evaluateLater, effect}) => {
        ...
        effect(() => {
            optionsLater(async (value) => {
                ...
                let mapCentre = center ?? home?.center ?? (typeof markers !== 'undefined' && markers.length > 0 ? markers[0].coordinates : undefined) ?? DEFAULT_CENTER;
