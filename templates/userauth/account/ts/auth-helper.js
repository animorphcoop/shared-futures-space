...
function comparePasswords() {
    if (passwordInputOne == null || passwordInputTwo == null)
        return;
    var passwordOne = passwordInputOne.value;
    var passwordTwo = passwordInputTwo.value;
