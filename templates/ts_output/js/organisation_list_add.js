...
function backFromOrganisations() {
    if (organisationList == null || checkbox == null || organisationInput == null || organisationDataBlock == null || organisationCheckboxBlock == null)
        return;
    if (checkbox.checked) {
        organisationList.classList.add('hidden');
...
function submitOrganisation() {
    ...
    if (organisationInput == null || organisationDataBlock == null || organisationList == null)
        return;
    organisationInput.value = selectedOrganisation;
